...
export function CityRow({ city, now, hour12, referenceOffsetMinutes, onRemove, roundedTop, roundedBottom }: CityRowProps) {
  ...
  return (
    <div
      className={`group flex w-full items-center gap-14 border-[0.5px] border-[#f1f5f9] bg-white px-6 py-4 dark:border-white/5 dark:bg-[#141416] ${
    ...
    >
      ...
      <button
        ...
        className="flex size-6 shrink-0 items-center justify-center rounded-full text-zinc-300 opacity-0 transition-opacity hover:bg-zinc-100 hover:text-zinc-600 group-hover:opacity-100 dark:text-white/20 dark:hover:bg-white/10 dark:hover:text-white/70"
      >
